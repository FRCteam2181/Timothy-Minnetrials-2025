...
public class CANDriveSubsystem extends SubsystemBase {
  ...
  public CANDriveSubsystem() {
    ...
    // config.peakCurrentLimit(DriveConstants.DRIVE_MOTOR_CURRENT_LIMIT);

    leftLeader.configVoltageCompSaturation(12.0);
    leftLeader.configPeakCurrentLimit(DriveConstants.DRIVE_MOTOR_CURRENT_LIMIT);

    leftFollower.configVoltageCompSaturation(12.0);
    leftFollower.configPeakCurrentLimit(DriveConstants.DRIVE_MOTOR_CURRENT_LIMIT);
    ...
    rightFollower.configPeakCurrentLimit(DriveConstants.DRIVE_MOTOR_CURRENT_LIMIT);
